...
/****************** CHMatchConfigurationGUI *********************************/
	...
	#define BT_AUTO_SET					CHMATCHCONFIGGUI_ID+13
	#define BT_REMOVE_SET				CHMATCHCONFIGGUI_ID+14
	#define BT_CHANGE_SIDE				CHMATCHCONFIGGUI_ID+15
...
/*********************************** ARDrawGUI **********************************/
#define ARDRAWGUI_ID							CH_GUI+180
	#define LB_OPTIONS									ARDRAWGUI_ID+1
	#define FR_DRAW										ARDRAWGUI_ID+2
	#define LB_NUM_INSCRIPTED							ARDRAWGUI_ID+3
	#define ED_NUM_INSCRIPTED							ARDRAWGUI_ID+4
	#define LB_NUM_COMPETITORS							ARDRAWGUI_ID+5
	#define ED_NUM_COMPETITORS							ARDRAWGUI_ID+6
	#define LB_FIRST_TARGET								ARDRAWGUI_ID+7
	#define ED_FIRST_TARGET								ARDRAWGUI_ID+8
	#define LB_LAST_TARGET								ARDRAWGUI_ID+9
	#define ED_LAST_TARGET								ARDRAWGUI_ID+10
	#define LB_COMP_BY_TARGET							ARDRAWGUI_ID+11
	#define ED_COMP_BY_TARGET							ARDRAWGUI_ID+12
	#define FR_TYPE										ARDRAWGUI_ID+13
	#define LB_TYPE_DRAW								ARDRAWGUI_ID+14
	#define RD_TYPE_SEX									ARDRAWGUI_ID+15
	#define RD_TYPE_EVENT								ARDRAWGUI_ID+16
	#define RD_TYPE_DISCIPLINE							ARDRAWGUI_ID+17
	#define RD_TYPE_MEDICAL_CLASS						ARDRAWGUI_ID+18
	#define CH_AUTO_PARAM								ARDRAWGUI_ID+19
	#define BT_DO_DRAW									ARDRAWGUI_ID+20
	#define BT_REMOVE_DRAW								ARDRAWGUI_ID+21
	#define BT_REDRAW_RK								ARDRAWGUI_ID+22
	#define BT_EXIT										ARDRAWGUI_ID+23
	#define BT_ASIGN_DRAW								ARDRAWGUI_ID+24
	#define CH_TARGET_BYES								ARDRAWGUI_ID+25
	#define CH_TARGET_DOUBLE_BYES						ARDRAWGUI_ID+26
